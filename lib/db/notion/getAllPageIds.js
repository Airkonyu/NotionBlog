...
export default function getAllPageIds(
  ...
  // Only fall back to page_sort when the query produced no page id at all.
  // Notion may return a view object that exists but carries no blockIds; keying
  // the decision off object presence alone would skip this fallback and leave
  // pageSet empty, which surfaces as an empty post list on the site.
